...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleDeletion = function () {
	        ...
	        switch (_context.prev = _context.next) {
	          ...
	          case 4:
	            ...
	            return _promise2.default.all(config.resize.map(function (resize) {
	              return deleteImage(event, resize);
	            }));
	  ...
	  return function handleDeletion(_x) {
	...
	var _apex = __webpack_require__(373);

	var _apex2 = _interopRequireDefault(_apex);

	var _awsSdk = __webpack_require__(374);
	...
	function getConfig(event) {
	  return _promise2.default.all([s3.getObject({
	    ...
	    return (0, _extends3.default)({}, configs[0], configs[1]);
	  }).catch(function (err) {
	    console.error(err);
	...
	exports.default = (0, _apex2.default)(function (event) {
	  return _promise2.default.all(event.Records.map(function (rec) {
	    return handleDeletion(rec.s3);
	  }));
	});
